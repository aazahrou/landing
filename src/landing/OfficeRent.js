...
const Photos = () => {
  ...
  return <PhotosContainer>
    <Slider {...settings}>
      ...
      <div>
        <img src={img3} height="300" />
      </div>
      <div>
        <img src={img4} height="300" />
      </div>
      <div>
        <img src={img5} height="300" />
      </div>
      <div>
        <img src={img6} height="300" />
      </div>
      <div>
        <img src={img7} height="300" />
      </div>
      <div>
        <img src={img8} height="300" />
      </div>
    </Slider>
  </PhotosContainer>
};
